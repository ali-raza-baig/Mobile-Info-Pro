...
const BrandAboutSection = ({ brandAbout }: { brandAbout: any }) => {
    const samsungBrandInfo = [
        {
            id: 1,
            title: "Founded",
            value: brandAbout.founded,
            icon: FaCalendar,
        },
        {
            id: 2,
            title: "Headquarters",
            value: brandAbout.headquarters,
            icon: FaLocationDot,
        },
        {
            id: 3,
            title: "Popular Series",
            value: brandAbout.popularSeries.join(', '),
            icon: FaMobileScreen,
        },
        {
            id: 4,
            title: "Operating System",
            value: brandAbout.operatingSystem,
            icon: FaAndroid,
        },
        {
            id: 5,
            title: "Global Presence",
            value: brandAbout.globalPresence,
            icon: FaGlobe,
        },
        {
            id: 6,
            title: "Official Website",
            value: brandAbout.officialWebsite,
            icon: FaLink,
        },
    ];
    return (
